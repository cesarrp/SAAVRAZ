...
#        FreqTicksLabels = [str(Fs/2-int((f*Fs) / (2*nfft))) for f in FreqTicks]
        ...
        plt.colorbar()
    ## ima change this beach: was plt.show()
        createdate = str("cromatograma_") + str(datetime.datetime.now()).split(' ')[1] + str(".png")
        plt.savefig(createdate, bbox_inches='tight')
        # plt.show()
...
def beatExtraction(stFeatures, winSize, PLOT=False):
    ...
    if PLOT:
    ## ima change this beach: was -- plt.show(block=False)
        createdate = str("beatExtract_") + str(datetime.datetime.now()).split(' ')[1] + str(".png")
        plt.savefig(createdate, bbox_inches='tight')
        # plt.show(block=False)
    ...
    ## ima change this beach: was plt.show(block=True)
        createdate = str("beatExtract500_") + str(datetime.datetime.now()).split(' ')[1] + str(".png")
        plt.savefig(createdate, bbox_inches='tight')
        # plt.show(block=True)
...
def stSpectogram(signal, Fs, Win, Step, PLOT=False):
    ...
    if (PLOT):
        ...
        plt.colorbar()
    ## ima change this beach: was -- plt.show()
        createdate = str("espectrograma_") + str(datetime.datetime.now()).split(' ')[1] + str(".png")
        plt.savefig(createdate, bbox_inches='tight')
        # plt.show()
